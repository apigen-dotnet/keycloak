...
/// </summary>
public partial class ClientInitialAccessClient : IClientInitialAccessClient
{
  ...
  /// </summary>
  public async Task<List<ClientInitialAccessPresentation>> GetAsync(string realm, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task<ClientInitialAccessCreatePresentation> PostAsync(string realm, Apigen.Keycloak.Admin.Models.ClientInitialAccessCreatePresentation clientInitialAccessCreatePresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
