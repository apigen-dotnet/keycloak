...
public partial class GroupsClient : IGroupsClient
{
  ...
  /// </summary>
  public async Task<List<GroupRepresentation>> GetAsync(string realm, GetGroupsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.GroupRepresentation groupRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
  ...
  /// </summary>
  public async Task<List<GroupRepresentation>> GetAdminRealmsGroupsChildrenAsync(string realm, string groupId, GetGroupsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task PostAsync(string realm, string groupId, Apigen.Keycloak.Admin.Models.GroupRepresentation groupRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task<ManagementPermissionReference> GetAdminRealmsGroupsManagementPermissionsAsync(string realm, string groupId, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task<ManagementPermissionReference> PutAsync(string realm, string groupId, Apigen.Keycloak.Admin.Models.ManagementPermissionReference managementPermissionReference, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
