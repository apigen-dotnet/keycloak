...
public partial class WorkflowsClient
{
  ...
  /// </summary>
  public async Task<WorkflowRepresentation> GetWorkflowsAsync(string realm, GetWorkflowsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostWorkflowsAsync(string realm, Apigen.Keycloak.Admin.Models.WorkflowRepresentation workflowRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
  ...
  /// </summary>
  public async Task<WorkflowRepresentation> GetAsync(string resourceId, string realm, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task<WorkflowRepresentation> GetAsync(string realm, string id, GetWorkflowsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task UpdateAsync(string realm, string id, Apigen.Keycloak.Admin.Models.WorkflowRepresentation workflowRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task DeleteAsync(string realm, string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task PostWorkflowsAsync(string resourceId, string type, string realm, string id, PostWorkflowsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task PostWorkflowsAsync(string resourceId, string type, string realm, string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["resourceId"] = resourceId,
