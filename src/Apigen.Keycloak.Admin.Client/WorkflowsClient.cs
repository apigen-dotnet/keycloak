...
public partial class WorkflowsClient : IWorkflowsClient
{
  ...
  /// </summary>
  public async Task<WorkflowRepresentation> GetAsync(string realm, GetWorkflowsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.WorkflowRepresentation workflowRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
  ...
  /// </summary>
  public async Task PostAsync(string realm, PostWorkflowsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
    };
    string url = "realms/{realm}/workflows/migrate".BuildUrl(pathParams, request);
  ...
  /// </summary>
  public async Task<WorkflowRepresentation> GetAdminRealmsWorkflowsAsync(string realm, string id, GetWorkflowsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task PostAsync(string resourceId, string type, string realm, string id, PostWorkflowsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task PostAdminRealmsWorkflowsDeactivateAsync(string resourceId, string type, string realm, string id, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["resourceId"] = resourceId,
