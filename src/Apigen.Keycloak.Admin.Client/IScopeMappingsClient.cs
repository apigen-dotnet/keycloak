...
public partial interface IScopeMappingsClient
{
  ...
  /// </summary>
  Task<MappingsRepresentation> GetAsync(string realm, string clientScopeId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string realm, string clientScopeId, string client, List<RoleRepresentation> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Remove client-level roles from the client&apos;s scope.
  /// Operation: DELETE /admin/realms/{realm}/client-scopes/{client-scope-id}/scope-mappings/clients/{client}
  /// </summary>
  Task DeleteAsync(string realm, string clientScopeId, string client, List<RoleRepresentation> body, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<List<RoleRepresentation>> GetAdminRealmsClientScopesScopeMappingsClientsAvailableAsync(string realm, string clientScopeId, string client, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<List<RoleRepresentation>> GetAdminRealmsClientScopesScopeMappingsClientsCompositeAsync(string realm, string clientScopeId, string client, GetScopeMappingsRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string realm, string clientScopeId, List<RoleRepresentation> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Remove a set of realm-level roles from the client&apos;s scope
  /// Operation: DELETE /admin/realms/{realm}/client-scopes/{client-scope-id}/scope-mappings/realm
  /// </summary>
  Task DeleteAsync(string realm, string clientScopeId, List<RoleRepresentation> body, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<List<RoleRepresentation>> GetAdminRealmsClientScopesScopeMappingsRealmCompositeAsync(string realm, string clientScopeId, GetScopeMappingsRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAdminRealmsClientTemplatesScopeMappingsClientsAsync(string realm, string clientScopeId, string client, List<RoleRepresentation> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Remove client-level roles from the client&apos;s scope.
  /// Operation: DELETE /admin/realms/{realm}/client-templates/{client-scope-id}/scope-mappings/clients/{client}
  /// </summary>
  Task DeleteAdminRealmsClientTemplatesScopeMappingsClientsAsync(string realm, string clientScopeId, string client, List<RoleRepresentation> body, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAdminRealmsClientTemplatesScopeMappingsRealmAsync(string realm, string clientScopeId, List<RoleRepresentation> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Remove a set of realm-level roles from the client&apos;s scope
  /// Operation: DELETE /admin/realms/{realm}/client-templates/{client-scope-id}/scope-mappings/realm
  /// </summary>
  Task DeleteAdminRealmsClientTemplatesScopeMappingsRealmAsync(string realm, string clientScopeId, List<RoleRepresentation> body, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAdminRealmsClientsScopeMappingsClientsAsync(string realm, string clientUuid, string client, List<RoleRepresentation> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Remove client-level roles from the client&apos;s scope.
  /// Operation: DELETE /admin/realms/{realm}/clients/{client-uuid}/scope-mappings/clients/{client}
  /// </summary>
  Task DeleteAdminRealmsClientsScopeMappingsClientsAsync(string realm, string clientUuid, string client, List<RoleRepresentation> body, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAdminRealmsClientsScopeMappingsRealmAsync(string realm, string clientUuid, List<RoleRepresentation> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Remove a set of realm-level roles from the client&apos;s scope
  /// Operation: DELETE /admin/realms/{realm}/clients/{client-uuid}/scope-mappings/realm
  /// </summary>
  Task DeleteAdminRealmsClientsScopeMappingsRealmAsync(string realm, string clientUuid, List<RoleRepresentation> body, CancellationToken cancellationToken = default);
