...
public partial interface IAuthenticationManagementClient
{
  ...
  /// </summary>
  Task<JsonElement> GetAsync(string realm, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.AuthenticatorConfigRepresentation authenticatorConfigRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PutAsync(string id, string realm, Apigen.Keycloak.Admin.Models.AuthenticatorConfigRepresentation authenticatorConfigRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.AuthenticationExecutionRepresentation authenticationExecutionRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string executionId, string realm, Apigen.Keycloak.Admin.Models.AuthenticatorConfigRepresentation authenticatorConfigRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string executionId, string realm, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.AuthenticationFlowRepresentation authenticationFlowRepresentation, CancellationToken cancellationToken = default);

  /// <summary>
  /// Copy existing authentication flow under a new name The new name is given as &apos;newName&apos; attribute of the passed JSON object
  /// Operation: POST /admin/realms/{realm}/authentication/flows/{flowAlias}/copy
  /// </summary>
  Task PostAsync(string flowAlias, string realm, Dictionary<string, string> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Get authentication executions for a flow
  /// Operation: GET /admin/realms/{realm}/authentication/flows/{flowAlias}/executions
  /// </summary>
  Task<List<AuthenticationExecutionInfoRepresentation>> GetAdminRealmsAuthenticationFlowsExecutionsAsync(string flowAlias, string realm, CancellationToken cancellationToken = default);

  /// <summary>
  /// Update authentication executions of a Flow
  /// Operation: PUT /admin/realms/{realm}/authentication/flows/{flowAlias}/executions
  /// </summary>
  Task PutAsync(string flowAlias, string realm, Apigen.Keycloak.Admin.Models.AuthenticationExecutionInfoRepresentation authenticationExecutionInfoRepresentation, CancellationToken cancellationToken = default);

  /// <summary>
  /// Add new authentication execution to a flow
  /// Operation: POST /admin/realms/{realm}/authentication/flows/{flowAlias}/executions/execution
  /// </summary>
  Task PostAsync(string flowAlias, string realm, Dictionary<string, object?> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Add new flow with new execution to existing flow
  /// Operation: POST /admin/realms/{realm}/authentication/flows/{flowAlias}/executions/flow
  /// </summary>
  Task PostAdminRealmsAuthenticationFlowsExecutionsFlowAsync(string flowAlias, string realm, Dictionary<string, object?> body, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PutAsync(string id, string realm, Apigen.Keycloak.Admin.Models.AuthenticationFlowRepresentation authenticationFlowRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PutAsync(string alias, string realm, Apigen.Keycloak.Admin.Models.RequiredActionProviderRepresentation requiredActionProviderRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PutAsync(string alias, string realm, Apigen.Keycloak.Admin.Models.RequiredActionConfigRepresentation requiredActionConfigRepresentation, CancellationToken cancellationToken = default);

  /// <summary>
  /// Delete RequiredAction configuration
  /// Operation: DELETE /admin/realms/{realm}/authentication/required-actions/{alias}/config
  /// </summary>
  Task DeleteAdminRealmsAuthenticationRequiredActionsConfigAsync(string alias, string realm, CancellationToken cancellationToken = default);
