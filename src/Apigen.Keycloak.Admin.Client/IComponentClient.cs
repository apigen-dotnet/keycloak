...
public partial interface IComponentClient
{
  ...
  /// </summary>
  Task PutAsync(string id, string realm, Apigen.Keycloak.Admin.Models.ComponentRepresentation componentRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<List<ComponentTypeRepresentation>> GetAdminRealmsComponentsSubComponentTypesAsync(string id, string realm, GetComponentRequest? request = null, CancellationToken cancellationToken = default);
