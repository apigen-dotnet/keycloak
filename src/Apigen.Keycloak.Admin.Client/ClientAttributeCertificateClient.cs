...
/// </summary>
public partial class ClientAttributeCertificateClient : IClientAttributeCertificateClient
{
  ...
  /// </summary>
  public async Task<Stream> PostAsync(string realm, string clientUuid, string attr, Apigen.Keycloak.Admin.Models.KeyStoreConfig keyStoreConfig, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task<CertificateRepresentation> PostAsync(string realm, string clientUuid, string attr, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task<CertificateRepresentation> PostAsync(string realm, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
