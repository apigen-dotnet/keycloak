...
public partial interface IGroupsClient
{
  ...
  /// </summary>
  Task<List<GroupRepresentation>> GetAsync(string realm, GetGroupsRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// create or add a top level realm groupSet or create child.
  /// Operation: POST /admin/realms/{realm}/groups
  /// </summary>
  Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.GroupRepresentation groupRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<List<GroupRepresentation>> GetAdminRealmsGroupsChildrenAsync(string realm, string groupId, GetGroupsRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Set or create child.
  /// Operation: POST /admin/realms/{realm}/groups/{group-id}/children
  /// </summary>
  Task PostAsync(string realm, string groupId, Apigen.Keycloak.Admin.Models.GroupRepresentation groupRepresentation, CancellationToken cancellationToken = default);

  /// <summary>
  /// Return object stating whether client Authorization permissions have been initialized or not and a reference
  /// Operation: GET /admin/realms/{realm}/groups/{group-id}/management/permissions
  /// </summary>
  Task<ManagementPermissionReference> GetAdminRealmsGroupsManagementPermissionsAsync(string realm, string groupId, CancellationToken cancellationToken = default);

  /// <summary>
  /// Return object stating whether client Authorization permissions have been initialized or not and a reference
  /// Operation: PUT /admin/realms/{realm}/groups/{group-id}/management/permissions
  /// </summary>
  Task<ManagementPermissionReference> PutAsync(string realm, string groupId, Apigen.Keycloak.Admin.Models.ManagementPermissionReference managementPermissionReference, CancellationToken cancellationToken = default);
