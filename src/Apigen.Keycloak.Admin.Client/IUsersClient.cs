...
public partial interface IUsersClient
{
  ...
  /// </summary>
  Task<List<UserRepresentation>> GetAsync(string realm, GetUsersRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Create a new user Username must be unique.
  /// Operation: POST /admin/realms/{realm}/users
  /// </summary>
  Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.UserRepresentation userRepresentation, CancellationToken cancellationToken = default);

  /// <summary>
  /// Returns the number of users that match the given criteria.
  /// Operation: GET /admin/realms/{realm}/users/count
  /// </summary>
  Task<int> GetAdminRealmsUsersCountAsync(string realm, GetUsersRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// 
  /// Operation: GET /admin/realms/{realm}/users/profile
  /// </summary>
  Task<UserProfileConfig> GetAdminRealmsUsersProfileAsync(string realm, CancellationToken cancellationToken = default);

  /// <summary>
  /// 
  /// Operation: PUT /admin/realms/{realm}/users/profile
  /// </summary>
  Task<UserProfileConfig> PutAsync(string realm, Apigen.Keycloak.Admin.Models.UserProfileConfig userProfileConfig, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> GetAdminRealmsUsersConfiguredUserStorageCredentialTypesAsync(string realm, string userId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string credentialId, string newPreviousCredentialId, string realm, string userId, CancellationToken cancellationToken = default);

  /// <summary>
  /// Move a credential to a first position in the credentials list of the user
  /// Operation: POST /admin/realms/{realm}/users/{user-id}/credentials/{credentialId}/moveToFirst
  /// </summary>
  Task PostAsync(string credentialId, string realm, string userId, CancellationToken cancellationToken = default);

  /// <summary>
  /// Update a credential label for a user
  /// Operation: PUT /admin/realms/{realm}/users/{user-id}/credentials/{credentialId}/userLabel
  /// </summary>
  Task PutAsync(string credentialId, string realm, string userId, CancellationToken cancellationToken = default);

  /// <summary>
  /// Disable all credentials for a user of a specific type
  /// Operation: PUT /admin/realms/{realm}/users/{user-id}/disable-credential-types
  /// </summary>
  Task PutAsync(string realm, string userId, List<string> body, CancellationToken cancellationToken = default);

  /// <summary>
  /// Send an email to the user with a link they can click to execute particular actions.
  /// Operation: PUT /admin/realms/{realm}/users/{user-id}/execute-actions-email
  /// </summary>
  Task UpdateAdminRealmsUsersExecuteActionsEmailAsync(string realm, string userId, List<string> body, PutUsersRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PostAsync(string provider, string realm, string userId, Apigen.Keycloak.Admin.Models.FederatedIdentityRepresentation federatedIdentityRepresentation, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<List<GroupRepresentation>> GetAdminRealmsUsersGroupsAsync(string realm, string userId, GetUsersRequest? request = null, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task UpdateAdminRealmsUsersGroupsAsync(string groupId, string realm, string userId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task<JsonElement> PostAsync(string realm, string userId, CancellationToken cancellationToken = default);
  ...
  /// </summary>
  Task PutAsync(string realm, string userId, Apigen.Keycloak.Admin.Models.CredentialRepresentation credentialRepresentation, CancellationToken cancellationToken = default);

  /// <summary>
  /// Send an email to the user with a link they can click to reset their password.
  /// Operation: PUT /admin/realms/{realm}/users/{user-id}/reset-password-email
  /// </summary>
  Task PutAsync(string realm, string userId, PutUsersRequest? request = null, CancellationToken cancellationToken = default);

  /// <summary>
  /// Send an email-verification email to the user An email contains a link the user can click to verify their email address.
  /// Operation: PUT /admin/realms/{realm}/users/{user-id}/send-verify-email
  /// </summary>
  Task UpdateAdminRealmsUsersSendVerifyEmailAsync(string realm, string userId, PutUsersRequest? request = null, CancellationToken cancellationToken = default);
