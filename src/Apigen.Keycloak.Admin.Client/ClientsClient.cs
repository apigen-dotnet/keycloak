...
public partial class ClientsClient : IClientsClient
{
  ...
  /// </summary>
  public async Task<List<ClientRepresentation>> GetAsync(string realm, GetClientsRequest? request = null, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.ClientRepresentation clientRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
  ...
  /// </summary>
  public async Task<CredentialRepresentation> GetAdminRealmsClientsClientSecretAsync(string realm, string clientUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task<CredentialRepresentation> PostAsync(string realm, string clientUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task DeleteAdminRealmsClientsClientSecretRotatedAsync(string realm, string clientUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task PutAsync(string clientScopeId, string realm, string clientUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task<AccessToken> GetAdminRealmsClientsEvaluateScopesGenerateExampleAccessTokenAsync(string realm, string clientUuid, GetClientsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// Operation: GET /admin/realms/{realm}/clients/{client-uuid}/evaluate-scopes/generate-example-saml-response
  /// </summary>
  public async Task<SamlExampleResponse> GetAdminRealmsClientsEvaluateScopesGenerateExampleSamlResponseAsync(string realm, string clientUuid, GetClientsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
    ...
    string url = "realms/{realm}/clients/{client-uuid}/evaluate-scopes/generate-example-saml-response".BuildUrl(pathParams, request);
    ...
    try
    {
      ...
      string responseContent = await response.Content.ReadAsStringAsync(cancellationToken);
      HttpClientLog.LogTraceResponseBody(_logger, url, responseContent);
      SamlExampleResponse? result = JsonSerializer.Deserialize<SamlExampleResponse>(responseContent, JsonConfig.Default);
      return result ?? new SamlExampleResponse();
    }
    catch (OperationCanceledException) when (cancellationToken.IsCancellationRequested)
    {
      HttpClientLog.LogDebugRequestCancelled(_logger, "GET", url);
  ...
  /// </summary>
  public async Task<List<RoleRepresentation>> GetAsync(string realm, string clientUuid, string roleContainerId, GetClientsRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task GetAdminRealmsClientsInstallationProvidersAsync(string providerId, string realm, string clientUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
  ...
  /// </summary>
  public async Task<ManagementPermissionReference> PutAsync(string realm, string clientUuid, Apigen.Keycloak.Admin.Models.ManagementPermissionReference managementPermissionReference, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task PostAsync(string realm, string clientUuid, Dictionary<string, string> body, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task UpdateAdminRealmsClientsOptionalClientScopesAsync(string clientScopeId, string realm, string clientUuid, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["clientScopeId"] = clientScopeId,
