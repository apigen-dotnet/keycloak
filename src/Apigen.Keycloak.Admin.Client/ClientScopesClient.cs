...
/// </summary>
public partial class ClientScopesClient : IClientScopesClient
{
  ...
  /// </summary>
  public async Task<List<ClientScopeRepresentation>> GetAsync(string realm, CancellationToken cancellationToken = default)
  {
  ...
  /// </summary>
  public async Task PostAsync(string realm, Apigen.Keycloak.Admin.Models.ClientScopeRepresentation clientScopeRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm
  ...
  /// </summary>
  public async Task PutAsync(string realm, string clientScopeId, Apigen.Keycloak.Admin.Models.ClientScopeRepresentation clientScopeRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
  ...
  /// </summary>
  public async Task UpdateAdminRealmsClientTemplatesAsync(string realm, string clientScopeId, Apigen.Keycloak.Admin.Models.ClientScopeRepresentation clientScopeRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["realm"] = realm,
