...
/// </summary>
public partial class ComponentClient : IComponentClient
{
  ...
  /// </summary>
  public async Task PutAsync(string id, string realm, Apigen.Keycloak.Admin.Models.ComponentRepresentation componentRepresentation, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
  ...
  /// </summary>
  public async Task<List<ComponentTypeRepresentation>> GetAdminRealmsComponentsSubComponentTypesAsync(string id, string realm, GetComponentRequest? request = null, CancellationToken cancellationToken = default)
  {
    Dictionary<string, object> pathParams = new()
    {
      ["id"] = id,
